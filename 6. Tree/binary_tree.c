...
void main(){
    while(1){
        ...
        else if(strcmp(cmd,"1")==0) processLoad();
        else if(strcmp(cmd,"2")==0) processPrint();
        else if(strcmp(cmd,"3")==0) processFind();
        else if(strcmp(cmd,"4")==0) processHeight();
        else if(strcmp(cmd,"5")==0) processCount();
        else if(strcmp(cmd,"6")==0) processFindLeaves();
        else if(strcmp(cmd,"7")==0) processAddLeftChild();
        else if(strcmp(cmd,"8")==0) processAddRightChild();
        else if(strcmp(cmd,"9")==0) processStore();
    }
    freeTree(root);
}